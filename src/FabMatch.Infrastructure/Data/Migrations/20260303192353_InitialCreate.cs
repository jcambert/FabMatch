        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AnnualCapacityTonnes = table.Column<decimal>(type: "numeric", nullable: true),
                    MinOrderAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    MinOrderCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
                    MaxOrderAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    MaxOrderCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetEstimate = table.Column<decimal>(type: "numeric", nullable: true),
                    BudgetCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false),
                    RequiredProcesses = table.Column<string>(type: "text", nullable: false),
                    Materials = table.Column<string>(type: "text", nullable: false),
                    EmbeddingVector = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxThicknessMm = table.Column<decimal>(type: "numeric", nullable: true),
                    MaxDimensionXMm = table.Column<decimal>(type: "numeric", nullable: true),
                    MaxDimensionYMm = table.Column<decimal>(type: "numeric", nullable: true),
                    ToleranceMm = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductionCapabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductionCapabilities_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierId = table.Column<Guid>(type: "uuid", nullable: false),
                    AffinityScore = table.Column<double>(type: "double precision", nullable: false),
                    MatchRationale = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ClientRespondedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SupplierRespondedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Matches_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "text", nullable: true),
                    IsAnalysed = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentifiedProcesses = table.Column<string>(type: "text", nullable: false),
                    IdentifiedMaterials = table.Column<string>(type: "text", nullable: false),
                    EstimatedManufacturingCost = table.Column<decimal>(type: "numeric", nullable: true),
                    EstimatedSellingPrice = table.Column<decimal>(type: "numeric", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Analyses_Plans_PlanId",
                        column: x => x.PlanId,
                        principalTable: "Plans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Analyses_Plans_PlanId1",
                        column: x => x.PlanId1,
                        principalTable: "Plans",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Analyses_PlanId",
                table: "Analyses",
                column: "PlanId");

            migrationBuilder.CreateIndex(
                name: "IX_Analyses_PlanId1",
                table: "Analyses",
                column: "PlanId1",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_ProjectId_SupplierId",
                table: "Matches",
                columns: new[] { "ProjectId", "SupplierId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Matches_SupplierId",
                table: "Matches",
                column: "SupplierId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionCapabilities_SupplierId",
                table: "ProductionCapabilities",
                column: "SupplierId");
